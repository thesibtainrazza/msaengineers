    ...
    <section className="relative w-full py-24 bg-white overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
        ...
        <div className="flex flex-col items-start lg:pl-10 relative order-1 lg:order-2">
          <h4 className="text-[#ed1c24] font-bold tracking-[0.2em] text-xs md:text-sm mb-8 uppercase">Services</h4>
          
          <h2 className="text-4xl md:text-5xl lg:text-[4rem] font-light text-[#4a4a4a] leading-[1.1] tracking-tight mb-10">
            Full-circle, <span className="bg-[#ed1c24] text-white px-3 py-1 inline-block font-normal my-2">proven</span><br className="hidden lg:block"/>
            building services at<br className="hidden lg:block"/>
            an unmatched<br className="hidden lg:block"/>
            <span className="bg-[#ed1c24] text-white px-3 py-1 inline-block font-normal my-2">value.</span>
          </h2>
          ...
          <div className="w-full mt-16 shadow-2xl">
            <div className="w-full aspect-[4/3] md:aspect-[16/9] lg:aspect-[4/3] bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1541888081-35b8e104e761?q=80&w=2070&auto=format&fit=crop')" }}></div>
          </div>
        </div>
      </div>
    </section>
