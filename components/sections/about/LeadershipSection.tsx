...
import { LEADERS, LEADERSHIP_SECTION } from '@/content/about';
    ...
    <section className="relative w-full bg-white py-24 md:py-32" id="leadership">
      <div className="container-primary">
            ...
            <FadeIn direction="left">
              <h2 className="text-[3.5rem] font-[450] leading-[1.1] tracking-[-0.04em] text-text-dark md:text-[4.5rem]">
                Our <span className="relative inline-block">
                    ...
                    <span className="absolute bottom-1 left-0 -z-10 h-3 w-full bg-primary/20"></span>
                </span>
              </h2>
              <p className="mt-8 text-[1.6rem] font-light leading-[1.7] text-text-muted">
            ...
            <FadeIn direction="up" delay={0.2}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
                <div className="flex flex-col">
                  ...
                  <h3 className="text-[2.4rem] font-[450] text-primary">
                    {LEADERS[current].name}
                  </h3>
                  <p className="font-serif italic text-text-dark text-[1.4rem] mt-1">
                    {LEADERS[current].title}
                  </p>
                </div>

                <div className="md:pt-4 flex flex-col justify-between h-full">
                  <p className="text-[1rem] font-light leading-[1.7] text-text-muted">
                    {LEADERS[current].bio}
                  </p>
                  ...
                  <div className="mt-16 flex items-center gap-8">
                    ...
                    >
                      <svg
                        className="w-14 h-14 text-primary transition-transform duration-300 group-hover:-translate-x-1"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="1.7"
                        viewBox="0 0 24 24"
        ...
        <div className="mt-24 pt-20 border-t border-gray-200">
          <FadeIn direction="up">
            <h2 className="text-[1.8rem] md:text-[2.6rem] font-[450] leading-[1.2] tracking-[-0.04em] text-text-dark max-w-[82%]">
