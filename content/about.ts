...
export const LEADERSHIP_SECTION = {
  ...
  description: "The strength of MSA Engineers & Contractors is not built only through machinery, fabrication, or execution — it is built through people who understand responsibility on the ground. Our leadership stays closely connected to every project, ensuring decisions are practical, transparent, and execution-focused from planning to completion.",
  conclusionText: "Every decision at MSA Engineers & Contractors is driven by practical execution, long-term trust, and the responsibility that comes with industrial work. Our leadership keeps teams aligned, projects moving efficiently, and every structure built with the same ",
  conclusionHighlight: "discipline, precision, and commitment",
  conclusionEnd: " that shaped the company from the beginning."
};
